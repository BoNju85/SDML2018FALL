...
def run_tests(predictor, model_file, dataset, args, get_full_recommendation_list=False, k=20):
	# Load model
	...
	for sequence, user_id in dataset.test_set(epochs=1):
		...
		#print('sequence = {}, userid = {}'.format(sequence, user_id))
		#print('recommendation = {}'.format(recommendations))

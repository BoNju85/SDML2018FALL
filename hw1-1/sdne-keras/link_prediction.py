...
g = nx.read_edgelist('../t1-train.txt', create_using=nx.DiGraph())
...
train_set, test_edges = train_test_split(list(g.edges()), test_size=test_ratio)
...
def one_run(g, dev_edges, test_edges, params):
    ...
    eval_callback = PrecisionAtKEval(g, dev_edges, test_edges,
                                     ...
                                     ks=ks)
    model.fit(epochs=10, batch_size=batch_size,
